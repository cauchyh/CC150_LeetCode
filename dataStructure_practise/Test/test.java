...
public class test
{
	public static void main(String[] args)
	{
		...
		// // l5.next = l6;
		// // l6.next = l7;
		// ListNode res = SwapNodesInPair.swapPairs(l1);
		// res.display();
		// System.getProperties().list(System.out);
		// System.out.println(System.getProperty("user.name"));
		// System.out.println(System.getProperty("java.library.path"));
		// String in = "1101";
		// int res = DecodeWays.numDecodings(in);
		// System.out.println(res);
		// int[] num = {1,-1,-1,0};
		// // int res = ThreeSum.threeSum(num);
		// // System.out.println(res);
		// ArrayList<ArrayList<Integer>> res = ThreeSum.threeSum(num);
		// System.out.println(res);
